    ...
    return (
            ...
            <nav className="bg-neutral-50  shadow py-3 fixed top-0 left-0 right-0 z-50">
                ...
                <div className="container mx-auto flex justify-between items-center px-4 md:px-8 py-3">
                    <h2 style={{ textShadow: '1px 1px 2px blue' }} className="text-red-600 font-bold text-xl md:text-3xl cursor-pointer hover:text-yellow-500 hover:scale-105"><span style={{ textShadow: '1px 1px 1px red' }} className='mr-2 text-blue-700 hover:text-green-400'>Shopping</span>website</h2>
                ...
                <div className="hidden lg:flex space-x-4  ">
                    <Link  className='flex items-center gap-2 border  border-black px-3 py-1 hover:bg-gray-400 rounded '> <CiLogin /><span>Login</span> </Link >
                    <Link  className='flex items-center gap-2 border  border-black px-3 py-1 hover:bg-gray-400 rounded '> <CiUser /><span>Register</span> </Link >
     ...
     <span >
       ( {cartItems.length})
                ...
                {
                    menuOpen && (
                        <div className={`lg:hidden flex flex-col items-center space-y-3 font-josefin bg-neutral-50 overflow-hidden transition-all duration-500 ease-in-out transform origin-top ${menuOpen ? "max-h-96 opacity-100 scale-y-100" : "max-h-0 opacity-0 scale-y-0"}`}>
